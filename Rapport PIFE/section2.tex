...
La reconstruction 3D à partir de deux vues perspective a été très bien formalisé dans le livre de Hartley et Zisserman \cite{Hartley03Book}.
...
A partir des correspondances de points dans les deux images, nous pouvons calculer la matrice fondamentale $\mathbf{F}$ définie par (eq~\ref{eq:fondamentale})
\begin{equation}
