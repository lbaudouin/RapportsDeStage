...
On peut résoudre ce système d'équation par \warning{moindre carré} en utilisant la SVD\footnote{Singular Value Decomposition}.
\warning{Note that the minimum number of required corre-
