...
\smallfig{0.7}{images/Goedeme07.png}{[Goedemé07] Omnidirectional Vision based Topological Navigation}{fig:goedeme}
Plusieurs chercheurs utilisent les droites comme \cite{Goedeme07} qui  sont assez simple à détecter dans ce genre d'images.


\smallfig{0.6}{images/Dame10.png}{[Dame10PhD] A unified direct approach for visual servoing and visual tracking using mutual information}{fig:dame}
...
\smallfig{0.5}{images/Rituerto10.png} {Ici la courbe noire est la trajectoire réelle, la bleue est obtenue par l'odométrie, la rouge par la vision omnidirectionnelle} {fig:rituerto}
...
\smallfig{0.4}{images/Gutmann99.png}{[Gutmann99] Incremental Mapping of Large Cycle Environments}{fig:gutmann}
...
\smallfig{0.8}{images/Strasdat10.png}{[Strasdat10] Scale Drift-Aware Large Scale Monocular SLAM}{fig:strasdat}   
...
Tous les algorithmes vus utilisent un système de fermeture de boucles. \warning{Finir la phrase}
