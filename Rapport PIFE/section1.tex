...
\smallfig{0.2}{images/Aragues11.png}{[Aragues11PhD] Distributed Algorithms on Robotic Nectwoks for Coordination in Perception Tasks}{fig:aragues}  
...
\smallfig{0.2}{images/sovin.png}{Interface du logiciel \emph{Sovin} par J. Courbon}{fig:SOVIN}       
